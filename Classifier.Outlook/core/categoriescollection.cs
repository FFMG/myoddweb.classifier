...
namespace myoddweb.classifier.core
{
  public class CategoriesCollection
  {
    ...
    public CategoriesCollection( Engine engine ) :
      this(engine.Classify, engine.Folders, engine.Config, engine, engine.Magnets, engine.Logger)
    {

    }

    public CategoriesCollection(IClassify classify, IFolders folders, IConfig config, ICategories categories, IMagnets magnets, ILogger logger )
    {
      // the root folder.
      _folders = folders;
