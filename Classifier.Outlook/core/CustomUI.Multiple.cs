namespace myoddweb.classifier.core
{
  public partial class CustomUI
  {
    ...
    public bool IsMultipleItemsMenuVisible(Microsoft.Office.Core.IRibbonControl control)
    {
    ...
    /// <param name="control"></param>
    /// <returns></returns>
    public string GetMultipleItemsLabel(Microsoft.Office.Core.IRibbonControl control)
    {
      return "Myoddweb.Classifier";
    }

    public string GetMultipleItemsContent(Microsoft.Office.Core.IRibbonControl control)
    {
    ...
    /// <returns></returns>
    public string GetMenuFolder(Microsoft.Office.Core.IRibbonControl control)
    {
      return "";
    }
  }
