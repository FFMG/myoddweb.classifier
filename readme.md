# MyOddWeb.Classifier [![release](https://img.shields.io/badge/release-v0.7.0.4-brightgreen.png?style=default)](https://github.com/FFMG/myoddweb.classifier/releases/latest)
