# MyOddWeb.Classifier [![Release](https://img.shields.io/badge/release-v0.7.0.4-brightgreen.png?style=flat)](https://github.com/FFMG/myoddweb.classifier/releases/latest)
